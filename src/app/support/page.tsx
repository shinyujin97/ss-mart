  ...
  return (
    <div className="bg-[var(--gray-50)] min-h-screen">
      ...
      <section className="bg-[var(--black)] text-white py-12">
        <div className="max-w-[1340px] mx-auto px-4 md:px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <div className="font-[var(--font-mono)] text-[11px] text-[var(--red)] tracking-[3px] mb-2">CUSTOMER SUPPORT</div>
            <h1 className="text-[28px] md:text-[36px] font-black tracking-tight">고객 지원</h1>
          </div>
          {/* CS 연락처 */}
          <div className="flex flex-wrap gap-x-6 gap-y-4">
            {[
              ...
              <div key={c.label} className="text-left md:text-center border-l border-[#333] pl-6 first:border-l-0 first:pl-0">
