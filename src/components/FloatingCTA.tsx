  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col gap-2">
      ...
      <a
        ...
        rel="noreferrer"
        aria-label="카카오톡 문의"
        className="w-12 h-12 md:w-14 md:h-14 bg-[#FEE500] flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
      ...
      <a
        ...
        className="w-12 h-12 md:w-14 md:h-14 bg-[var(--red)] flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
