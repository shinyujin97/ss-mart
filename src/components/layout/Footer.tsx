...
const CATEGORIES = [
  ...
  { href: "/categories/fb-uniform", label: "F&B 유니폼" },
  { href: "/categories/medical", label: "의료 / 간호복" },
];
      ...
      <div className="max-w-[1340px] mx-auto px-6 py-8">
        <div className="flex justify-between items-start pb-7 border-b border-[#333]">
          ...
          <div>
            ...
            <a href="tel:031-430-0497" className="block font-[var(--font-display)] text-[28px] text-white tracking-wide mb-1 hover:text-[var(--yellow)] transition-colors">
              031-430-0497
            </a>
          ...
          {/* 카테고리 */}
          <div>
            <div className="text-white font-bold text-sm mb-2">상품 카테고리</div>
          ...
          <div className="text-left leading-relaxed">
            상호 : 에스에스종합상사&nbsp;&nbsp;&nbsp;대표 : 신상영<br />
            주소 : 경기도 시흥시 공단1대로 204 <span className="whitespace-nowrap">공구상가</span> 31동 111~112호<br />
            ...
            &nbsp;&nbsp;통신판매업신고 : 제 2020-경기시흥-0317 호<br />
            개인정보보호책임자 : 에스에스종합상사 운영팀장<br />
