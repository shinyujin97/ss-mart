...
**프로젝트명**: 에스에스종합상사 온라인 카탈로그 (SS Mart)
**도메인**: 작업복 / 안전화 / 안전용품 멀티브랜드 종합상사
**핵심 차별화**: 자수 / 마킹 서비스 (B2B + B2C) — 전화 문의 방식
**운영 모드**: 카탈로그 전용 (온라인 결제 없음, 전화 문의 031-430-0497)
**비즈니스 모델**:
- 80여 개 입점 브랜드 상품 카탈로그 제공
- 자수 / 마킹 안내 (문의 → 전화 상담)
- 단체주문 견적 접수 (온라인 폼 → 담당자 연락)
...
2. ❌ **디자인 토큰 임의 변경** (시안 일관성 깨짐)
3. ❌ **PII / 결제 정보** 평문 저장 또는 로그
4. ❌ **고객 페이지에 가격 노출** (카탈로그 전용 모드 — 가격은 관리자 전용)
5. ❌ **자수 시뮬레이터 링크 복구** (전화 문의 방식으로 전환됨)
6. ❌ **장바구니 / 결제 기능 복구** (카탈로그 전용 모드)

## Quick Status

- **현재 단계**: 카탈로그 전용 운영 모드 (2026-05-06 전환)
- **운영 방식**: 온라인 판매 없음 → 전화 문의 031-430-0497
- **배포**: Vercel 프로덕션 운영 중 (https://ss-mart-ten.vercel.app)
- **다음 단계**: Cloudflare Pages 마이그레이션 검토 중
